...
/datum/species/ethereal
	...
	species_traits = list(MUTCOLORS, HAIR, HAS_FLESH, HAS_BONE,NOGENITALS,NOAROUSAL) // i mean i guess they have blood so they can have wounds too
	species_language_holder = /datum/language_holder/ethereal
	inherent_traits = list(TRAIT_NOHUNGER) // Nostra change - removed thrist
	sexes = FALSE
	toxic_food = NONE
	/*
